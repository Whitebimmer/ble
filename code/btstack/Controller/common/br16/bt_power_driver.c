...
static void __bt_regs_push(u32 *ptr, u8 num)
{
    ...
    *ptr++ = BTA_CON14;
    ...
    //BTA_CON14[4:1], BTA_CON13[9:5],   BTA_CON13[14:10],   BTA_CON14[7]
    SFR(BTA_CON14,1 ,4,0x0);
}
