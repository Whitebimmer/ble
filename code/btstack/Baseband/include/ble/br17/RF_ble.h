...
struct ble_param
{
    ...
    volatile unsigned long  TXSET    ; //16'd188     //len:116 RX:[20:12]  TX[8:0] 
    volatile unsigned long  RXSET    ; //16'd188     //len:116 RX:[20:12]  TX[8:0] 
    ...
    volatile unsigned long  ANL_OUT;     // 208 212 216  
