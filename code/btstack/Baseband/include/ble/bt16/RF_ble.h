...
struct ble_param
{
    ...
    volatile unsigned short RFTXCNTL0;
    volatile unsigned short RFTXCNTL1;
    volatile unsigned short RFRXCNTL0;
    volatile unsigned short RFRXCNTL1;
    volatile unsigned short RFPRIOCNTL;
    volatile unsigned short RFPRIOSTAT;
    volatile unsigned short IFSCNT;
    volatile unsigned short RFCONFIG;
    volatile unsigned short TARGETADRL;
    volatile unsigned short TARGETADRM;       //目标地址
    volatile unsigned short TARGETADRU;
    volatile unsigned short LOCALADRL;        //本地地址
    ...
    volatile unsigned short UNDEF[7];
    volatile unsigned int FRQ_TBL0[40];
    volatile unsigned int FRQ_TBL1[40];
};
